...
<html lang="en">
  ...
  <body>
	...
	<div id="blue">
	    <div class="container">
			<div class="row">
				<h3 class="text-center">Eastern Province.</h3>
			</div><!-- /row -->
	    </div> <!-- /container -->
	</div><!-- /blue -->
	 	...
	 	<div class="row">
	 		...
	 		<div class="col-lg-8">
	 			<div class="row">
					<?php
						include('connect.php');
						$pipsql = mysqli_query($dbcon,"SELECT * FROM products WHERE Province='Eastern Province' ORDER BY ID DESC LIMIT 0,9");
				...
				?>
		 		...
		 		<div class="hline"></div>
		 			<p>
		            	...
		            	<a class="btn btn-theme" href="school.php" role="button">Schools</a>
						<a class="btn btn-theme" href="hotel.php" role="button">Hotels</a>
						<a class="btn btn-theme" href="building.php" role="button">Quincalleries</a><a class="btn btn-theme" href="tools.php" role="button">Tools</a>		            	
		 			</p>
	 		</div>
	 	</div><!--/row -->
	 </div><!--/container -->
