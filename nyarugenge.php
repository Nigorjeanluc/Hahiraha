...
<html lang="en">
  ...
  <body>
	...
	<div id="blue">
	    <div class="container">
			<div class="row">
				<h3 class="text-center">Kigali City > Nyarugenge District</h3>
			</div><!-- /row -->
	    </div> <!-- /container -->
	</div><!-- /blue -->
	 ...
	 <div class="container mtb">
	 	<div class="row">
	 		...
	 		<div class="col-lg-8">
				 ...
				 <?php
					include('connect.php');
					$pipsql = mysqli_query($dbcon,"SELECT * FROM products WHERE District='Nyarugenge' ORDER BY ID DESC LIMIT 0,9");
					...
					<div class="col-md-4 portfolio-item">
						...
						<h6>Price: '.$myrow['Price'].'<br/>Seller: '.$myrow['Sellers'].'<br/>Place: '.$myrow['Sector'].'<br/>Quantity in store: '.$myrow['Quantity'].'<br/>Tel: '.$myrow['Phone'].'<br/>Date: '.$myrow['Date'].'</h6>
