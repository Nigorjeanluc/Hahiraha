    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> All sellers</a></li>
              ...
              <div class="box">
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <?php
                                    include("../connect.php");
                                    $sqli="SELECT * FROM seller ORDER BY ID DESC";
                                    ...
                                    echo'
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="text-center">
                                                <p><a href="editsel.php?id='.$row['ID'].'" class="btn bg-navy">Edit</a></p>
                                                <p><a href="../operations/operadelseller.php?del='.$row['ID'].'" class="btn bg-maroon">Delete</a></p>
                                            </td>
                                        </tr>';
                                    }
                                    ?>
