                    ...
                    <div class="box-body">
                        <div class="panel panel-info">
                            <div class="panel-body">
                                ...
                                $sqli="SELECT * FROM admin WHERE Name='$admin' ORDER BY ID DESC";
                                ...
                                echo'
                                    ...
                                    <div class="col-lg-4">
                                        <div class="panel panel-default">
                                            ...
                                            <div style="height:247px;" class="panel-body">
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="admin" type="text" value="'.$row['Name'].'">
                                                </div>
                                                <div class="form-group">
