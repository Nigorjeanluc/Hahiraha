	 ...
	 <div class="container mtb">
	 	<div class="row">
	 		...
	 		<div class="col-lg-8">
				 ...
				 <?php
					include('connect.php');
					$pipsql = mysqli_query($dbcon,"SELECT * FROM products WHERE Categorie='Hotels' ORDER BY ID DESC LIMIT 0,9");
				...
				?>
		 		...
		 		<div class="hline"></div>
		 			<p>
		            	...
		            	<a class="btn btn-theme" href="hotel.php" role="button">Hotels</a> 						<a class="btn btn-theme" href="building.php" role="button">Quincalleries</a><a class="btn btn-theme" href="tools.php" role="button">Tools</a>		            	
		 			</p>
	 		</div>
	 	</div><!--/row -->
	 </div><!--/container -->
