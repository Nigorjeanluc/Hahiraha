...
<html lang="en">
  ...
  <body>
	...
	<div id="blue">
	    <div class="container">
			<div class="row">
				<h3 class="text-center">Eastern Province > Bugesera District.</h3>
			</div><!-- /row -->
	    </div> <!-- /container -->
	</div><!-- /blue -->
	 ...
	 <div class="container mtb">
	 	<div class="row">
	 		...
	 		<div class="col-lg-8">
				 ...
				 <?php
					include('connect.php');
					$pipsql = mysqli_query($dbcon,"SELECT * FROM products WHERE District='Bugesera' ORDER BY ID DESC LIMIT 0,9");
