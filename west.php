...
<html lang="en">
  ...
  <body>
	...
	<div id="blue">
	    <div class="container">
			<div class="row">
				<h3 class="text-center">Western Province.</h3>
			</div><!-- /row -->
	    </div> <!-- /container -->
	</div><!-- /blue -->
	 	...
	 	<div class="row">
	 		...
	 		<div class="col-lg-8">
	 			<div class="row">
					<?php
						include('connect.php');
						$pipsql = mysqli_query($dbcon,"SELECT * FROM products WHERE Province='Western Province' ORDER BY ID DESC LIMIT 0,9");
	 		...
	 		<div class="col-lg-4">
		 		...
		 		<h4>Districts</h4>
		 		<div class="hline"></div>
			 		<p><a href="karongi.php"><i class="fa fa-angle-right"></i> Karongi</a> <span class="badge badge-theme pull-right">9</span></p>
